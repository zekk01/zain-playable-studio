...
export function initBook({ container, pageCount, pageSrc, cover, back, pdfUrl, reducedMotion = false }) {
  ...
  if (pdfUrl) {
    ...
    open.innerHTML = 'Open full PDF <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="1em" height="1em" style="vertical-align:-.12em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M9 7h8v8"/></svg>';
